...
I=bw;
m = zeros(size(I,1),size(I,2));          %-- creating initial mask before passing it to region_seg
m(200:320,95:180) = 1;
m(186:321,348:410) = 1;

seg = region_seg(I, m, 1200); %-- Run segmentation with passing image,mask and number of iteration
figure
